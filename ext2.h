...
/*
 * Structure of a blocks group descripto
 */
/* Exercise 2: print the first 6 fields */
struct ext2_group_desc
{
	...
	/* The following fields are not relevant for the exercises */
...
struct ext2_inode
{
	/* Exercise 3: extract type from i_mode */
	unsigned short i_mode; /* File mode */
	unsigned short i_uid;  /* Low 16 bits of Owner Uid */
	/* Exercise 3: print size */
	...
	/* Exercise 3: print links_count */
	unsigned short i_links_count; /* Links count */
	/* Exercise 3: print number of blocks - note that this value is actually blocks * 2 */
	unsigned int i_blocks; /* Blocks count IN DISK SECTORS*/
	unsigned int i_flags;  /* File flags */
	unsigned int osd1;	 /* OS dependent 1 */
	/* Exercise 3: print the contents of this array */
